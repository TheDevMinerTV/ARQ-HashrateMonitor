...
<body>
  ...
  <section class="readme">
    <article>
      <h1>ArQmA RPC Daemon and RPC Wallet Javascript Library</h1>
<p><a href="https://nodei.co/npm/@arqma/arqma-rpc/"><img src="https://nodei.co/npm/@arqma/arqma-rpc.png" alt="NPM"></a></p>
<p>Javascript library to interact with RPC Daemon and RPC Wallet.<br>
All requests are queued and use promises.<br>
The library supports HTTP, HTTPS and digest authentication.</p>
<h2>RPCDaemon</h2>
<p>Please refer to the <a href="https://arqma.github.io/arqma-rpc-js/RPCDaemon.html">documentation</a> and look at the unit tests.<br>
Init without authentication:</p>
<pre class="prettyprint source"><code>let rpcDaemon = new RPCDaemon({
  url: 127.0.0.1:39994
})
</code></pre>
<h2>RPCWallet</h2>
<p>Please refer to the <a href="https://arqma.github.io/arqma-rpc-js/RPCWallet.html">documentation</a> and look at the unit tests.<br>
Init with authentication:</p>
<pre class="prettyprint source"><code>let rpcWallet = new RPCWallet({
...
<h2>Generate JSDoc documentation</h2>
<pre class="prettyprint source"><code>npm run generate-docs
</code></pre>
<h2>Get unit tests list</h2>
